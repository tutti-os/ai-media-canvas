...
// ---------------------------------------------------------------------------
// AI Media Canvas logo SVG (reused from loading-screen)
// ---------------------------------------------------------------------------

function AimcLogo({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 100 100"
      fill="none"
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <AimcLogo className="size-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6" />
            <span className="font-bold text-lg tracking-tight">AI Media Canvas</span>
          </Link>
