...
export default interface Resources {
  "brandKit": {
    ...
    "applyToNewProjects": "应用到新项目",
    "empty": "暂无品牌套件",
    "extractFromUrl": "从 URL 提取",
    "kitNamePlaceholder": "套件名称",
    "selector": {
      "invalid": "品牌套件: 已失效",
      "none": "品牌套件: 无"
    },
  ...
  "chat": {
    ...
    "input": {
      ...
      "mentionEmpty": "无匹配项",
      "mentionLoading": "正在搜索...",
      "mentionPaletteAgents": "Agents",
      "mentionPaletteApps": "Apps",
      "mentionPaletteCycleFilter": "切换分组",
      "mentionPaletteListbox": "Mention 建议",
      "mentionPaletteMoveSelection": "移动选择",
      "mentionPaletteTabHint": "Mention 分组",
      "mentionRemove": "移除引用",
