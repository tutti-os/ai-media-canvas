...
export const homeDiscoverySeedCategories: HomeDiscoveryCategory[] = [
  {
    ...
    cases: [
      discoveryCase(
        ...
        "/images/home-seeds/cultural-arts-center.webp",
        "Studio Arken",
        "/images/home-seeds/authors/studio-arken.webp",
        549,
        7,
  ...
  },
  {
    ...
    cases: [
      discoveryCase(
        "disc-poster-01",
        "Vintage Car Poster",
        "/images/home-seeds/vintage-car-poster.webp",
        "Retro Workshop",
        "/images/home-seeds/authors/retro-workshop.webp",
        359919,
        286,
  ...
  },
  {
    ...
    cases: [
      discoveryCase(
        ...
        "Cat Tarot Cards",
        "/images/home-seeds/cat-tarot-cards.webp",
        "Mochi Art",
        "/images/home-seeds/authors/mochi-art.webp",
        2054,
        116,
  ...
  },
  {
    ...
    cases: [
      discoveryCase(
        ...
        "/images/home-seeds/fallout-cake-shop.webp",
        "Pixel Forge",
        "/images/home-seeds/authors/pixel-forge.webp",
        4338,
        192,
  ...
  },
  {
    ...
    cases: [
      discoveryCase(
        ...
        "/images/home-seeds/creepy-clown-avatar.webp",
        "Dark Carnival",
        "/images/home-seeds/authors/dark-carnival.webp",
        749,
        12,
  ...
  },
  {
    ...
    cases: [
      discoveryCase(
        "disc-story-01",
        "Mixtapes Emotions!",
        "/images/home-seeds/mixtapes-emotions.webp",
        "Frame Studio",
        "/images/home-seeds/authors/frame-studio.webp",
        3057,
        49,
  ...
  },
  {
    ...
    cases: [
      discoveryCase(
        ...
        "/images/home-seeds/robot-hand-product-visualization.webp",
        "Future Lab",
        "/images/home-seeds/authors/future-lab.webp",
        769,
        27,
  ...
  },
  {
    ...
    cases: [
      discoveryCase(
        ...
        "/images/home-seeds/architecture-studio-website.webp",
        "Arc Design",
        "/images/home-seeds/authors/arc-design.webp",
        1453,
        24,
