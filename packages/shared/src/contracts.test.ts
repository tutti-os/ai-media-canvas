...
describe("@aimc/shared contracts", () => {
  it("shares the health response schema for server and web", () => {
    ...
    expect(parsed.service).toBe("ai-media-canvas-server");
  });
  ...
  it("shares the viewer bootstrap contract for GET /api/viewer", () => {
    ...
    const parsed = viewerResponseSchema.parse({
      profile: {
        id: "user_123",
        email: "maker@aimc.test",
        displayName: "AI Media Canvas Maker",
        avatarUrl: "https://example.com/avatar.png",
      },
      workspace: {
        id: "workspace_123",
        name: "AI Media Canvas Maker",
        type: "personal",
