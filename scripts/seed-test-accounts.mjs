#!/usr/bin/env node
/**
 * Seed test accounts for AI Media Canvas open-source deployment.
 *
...
const TEST_ACCOUNTS = [
  { email: "free@test.aimc.app",    plan: "free",    credits: 50    },
  { email: "starter@test.aimc.app", plan: "starter", credits: 1_200 },
  { email: "pro@test.aimc.app",     plan: "pro",     credits: 5_000 },
  { email: "ultra@test.aimc.app",   plan: "ultra",   credits: 15_000 },
];

const PASSWORD = "opensourceaimc";
